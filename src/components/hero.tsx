...
export default function Hero() {
    return (
        <section className=' h-full relative py-24'>
            <div className='flex items-center justify-between'>
                <div className='w-[35%] h-full py-24 '>
                    <h3 className='text-[60px] font-bold -tracking-[2px]'>Discover the World's <span className='text-[#f1764d]'>Hidden</span> Wonders</h3>
